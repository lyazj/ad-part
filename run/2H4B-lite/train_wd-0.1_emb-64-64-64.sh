...
python3 $HOME/work/weaver-core-dev/weaver/train.py \
    --use-amp -o embed_dims '[64,64,64]' -o pair_embed_dims '[32,32,32]' -o num_heads 4 --optimizer-option weight_decay 0.1 \
    ...
    --model-prefix ${NAME/train/lite} --tensorboard _${NAME/train/lite} --log-file ${NAME}.log \
