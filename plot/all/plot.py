...
plt.xlabel(r'Leading fat jet $p_\mathrm{T}$ [GeV]'); plt.ylabel('Density')
...
plt.xlabel(r'Leading fat jet $\tau_{21}$ in mass window [100, 150] GeV'); plt.ylabel('Density')
...
plt.xlabel(r'Leading fat jet HbbVSQCD in mass window [100, 150] GeV'); plt.ylabel('Density')
